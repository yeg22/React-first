            ...
            <section className="sale_section">
                ...
                <div className = "sale_wrap">
                    <ul className = "sale_products">
                        <li>
                            <a href="#" className = "sale_products_img"></a>
                            <span className = "sale_products_info_1"><a href="#">[LOTS OF LOVE] 손맛듬뿍 새우볶음밥</a></span>
                ...
                <div className="category_md_wrap">
                    <div className = "category_md">
                        <ul className = "category_md_list">
                            <li onClick={() => this.clickHandler(0)}>선물하기</li>
                            <li onClick={() => this.clickHandler(1)}>채소</li>
                            <li onClick={() => this.clickHandler(2)}>과일·견과·쌀</li>
                            <li onClick={() => this.clickHandler(3)}>수산·해산·건어물</li>
                            <li onClick={() => this.clickHandler(4)}>정육·계란</li>
                            <li onClick={() => this.clickHandler(5)}>국·반찬·메인요리</li>
                            <li onClick={() => this.clickHandler(6)}>샐러드·간편식</li>
                            <li onClick={() => this.clickHandler(7)}>면·양념·오일</li>
                            <li onClick={() => this.clickHandler(8)}>생수·음료·우유·커피</li>
                            <li onClick={() => this.clickHandler(9)}>간식·과자·떡</li>
                            <li onClick={() => this.clickHandler(10)}>베이커리·치즈·델리</li>
                            <li onClick={() => this.clickHandler(11)}>건강식품</li>
                            <li onClick={() => this.clickHandler(12)}>생활용품·리빙</li>
                            <li onClick={() => this.clickHandler(13)}>스킨케어·메이크업</li>
                            <li onClick={() => this.clickHandler(14)}>헤어·바디·구강</li>
                            <li onClick={() => this.clickHandler(15)}>주방용품</li>
                            <li onClick={() => this.clickHandler(16)}>가전제품</li>
                            <li onClick={() => this.clickHandler(17)}>베이비·키즈</li>
                            <li onClick={() => this.clickHandler(18)}>반려동물</li>
                        </ul>
                    </div>
                </div>
                <div className = "product_slide">
